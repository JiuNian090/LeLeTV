...
版本号保存在 `VERSION.txt`（当前 `v3.5.3`），`npm run build` 时由 `scripts/generate-version.mjs` 完成：
...
- 🎨 样式 版本更新弹窗改用系统更新风格的蓝色，按钮文案统一为「立即更新」

### v3.5.2 (2026-09-13)
- 🎉 新增 关于页新增分享按钮，一键分享网站与邀请码
- 🎉 新增 检测到新版本时自动弹窗提示，可一键更新
- ✨ 优化 隐私政策与版本提示弹窗按顺序出现，不再相互遮挡
