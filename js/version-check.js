...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://ghfast.top/raw.githubusercontent.com/JiuNian090/LeLeTV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/JiuNian090/LeLeTV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/Jiunian090/LeLeTV', '_blank');
                    });
                }
            }, 100);
        } else {
...
function setupChangelogLink() {
    ...
    if (changelogLink) {
        changelogLink.addEventListener('click', (e) => {
            e.preventDefault();
            window.location.href = 'about.html#changelog';
        });
    }
}
