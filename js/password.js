...
function showPasswordModal() {
    ...
    if (passwordModal) {
        ...
        if (isPasswordRequired()) {
            ...
            if (errorMsg) {
                errorMsg.innerHTML = '为确保安全，必须设置 PASSWORD 环境变量才能使用本服务，请☞<span class="contact-link text-blue-400 underline cursor-pointer transition-all duration-300 hover:text-blue-300 hover:underline-offset-2">联系乐乐</span>进行配置';
            ...
            if (description) description.innerHTML = '请输入密码继续访问，进入后请仔细阅读使用说明，包含了使用方法和反诈警告⚠️，如若密码错误可以☞<span class="contact-link text-blue-400 underline cursor-pointer transition-all duration-300 hover:text-blue-300 hover:underline-offset-2">联系乐乐</span>获取密码';
